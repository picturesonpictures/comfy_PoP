class ConditioningMultiplierPoP:
    @classmethod
    def INPUT_TYPES(cls):
...
class ConditioningNormalizerPoP:
    @classmethod
    def INPUT_TYPES(cls):
...
NODE_CLASS_MAPPINGS = {
    "ConditioningMultiplierPoP": ConditioningMultiplierPoP,
    "ConditioningNormalizerPoP": ConditioningNormalizerPoP
} 
NODE_DISPLAY_NAME_MAPPINGS = {
    "ConditioningMultiplierPoP": "Conditioning Multiplier PoP",
    "ConditioningNormalizerPoP": "Conditioning Normalizer PoP"
}