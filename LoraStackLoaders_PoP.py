...
class LoraStackLoader_PoP:
    ...
    def apply_loras(self, model, clip, switch_1, lora_name_1, strength_model_1, strength_clip_1, switch_2, lora_name_2,
                    strength_model_2, strength_clip_2, switch_3, lora_name_3, strength_model_3, strength_clip_3):
        loras = [
